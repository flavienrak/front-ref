      ...
      <div className="w-full max-w-7xl flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <div
            ...
            className="flex justify-center items-center p-2 rounded-full bg-[var(--primary-color)]/10 cursor-pointer hover:bg-[var(--primary-color)]/15"
          >
            {mode === 'light' ? (
              <Moon size={26} className="text-[var(--primary-color)]" />
            ) : (
              <Sun size={26} className="text-[var(--primary-color)]" />
            )}
          </div>
          ...
          {user && (
            <button
              ...
              className={`h-10 w-36 flex items-center justify-center gap-2 px-3 rounded-md text-sm text-white bg-red-400 ${
                isLoading
